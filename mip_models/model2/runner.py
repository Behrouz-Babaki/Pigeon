...
def read_graph(graph_fname, cl_fname=None, ml_fname=None):
    node_names = dict()
    node_ids = dict()
    edges = set()
...
if __name__ == '__main__':
    ...
    parser.add_argument('cl_file', 
                        help='file containing the can-not-link constraints')
    parser.add_argument('ml_file', 
                        help='file containing the must-link constraints')
    ...
    (n_vertices, edges,
    cl_constraints, ml_constraints,
    node_ids) = read_graph(args.graph_file,
                          args.cl_file,
                          args.ml_file)
